...
start:
    ...
    ; some BIOS might start at 07C0:0000 instead of 0000:7C00, make sure we are in the
    ; expected location
    push es
    push word .after
    retf
...
.after:
    ...
    ; BIOS should be set DL to drive number
...
.read_finish:
    ; jump to our kernel
    mov dl, [ebr_drive_number]                  ; boot devicesa in dl
...
lba_to_chs:
    ...
    shl ah, 6
    or cl, ah                           ; put upper 2 buts of cylinder in CL
